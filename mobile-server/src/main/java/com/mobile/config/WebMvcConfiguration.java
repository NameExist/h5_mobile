...
//    }
    ...
    public Docket docket1(){
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //指定生成接口需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.mobile.controller.admin"))
    ...
    public Docket docket2(){
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //指定生成接口需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.mobile.controller.user"))
                .paths(PathSelectors.any())
                .build();
